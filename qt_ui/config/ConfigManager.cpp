...
void ConfigManager::writeHotkeyToSettings(int index, const HotkeyData& data) {
    ...
    m_settings->setValue(prefix + "target_class_1",      data.targetClass1);
    m_settings->setValue(prefix + "target_y_top_1",      static_cast<double>(data.targetYTop1));
    m_settings->setValue(prefix + "target_y_bot_1",      static_cast<double>(data.targetYBot1));
    m_settings->setValue(prefix + "target_min_conf_1",   static_cast<double>(data.targetMinConf1));
    m_settings->setValue(prefix + "target_class_2",      data.targetClass2);
    m_settings->setValue(prefix + "target_y_top_2",      static_cast<double>(data.targetYTop2));
    m_settings->setValue(prefix + "target_y_bot_2",      static_cast<double>(data.targetYBot2));
    m_settings->setValue(prefix + "target_min_conf_2",   static_cast<double>(data.targetMinConf2));
    m_settings->setValue(prefix + "target_class_3",      data.targetClass3);
    m_settings->setValue(prefix + "target_y_top_3",      static_cast<double>(data.targetYTop3));
    m_settings->setValue(prefix + "target_y_bot_3",      static_cast<double>(data.targetYBot3));
    m_settings->setValue(prefix + "target_min_conf_3",   static_cast<double>(data.targetMinConf3));
    m_settings->setValue(prefix + "target_aim_range",    data.targetAimRange);
...
ConfigManager::HotkeyData ConfigManager::readHotkeyFromSettings(int index) const {
    ...
    data.targetClass1    = m_settings->value(prefix + "target_class_1", 0).toInt();
    data.targetYTop1     = m_settings->value(prefix + "target_y_top_1", 0.0).toFloat();
    data.targetYBot1     = m_settings->value(prefix + "target_y_bot_1", 1.0).toFloat();
    data.targetMinConf1  = m_settings->value(prefix + "target_min_conf_1", 0.0).toFloat();
    data.targetClass2    = m_settings->value(prefix + "target_class_2", 1).toInt();
    data.targetYTop2     = m_settings->value(prefix + "target_y_top_2", 0.0).toFloat();
    data.targetYBot2     = m_settings->value(prefix + "target_y_bot_2", 0.4).toFloat();
    data.targetMinConf2  = m_settings->value(prefix + "target_min_conf_2", 0.0).toFloat();
    data.targetClass3    = m_settings->value(prefix + "target_class_3", 2).toInt();
    data.targetYTop3     = m_settings->value(prefix + "target_y_top_3", 0.0).toFloat();
    data.targetYBot3     = m_settings->value(prefix + "target_y_bot_3", 0.3).toFloat();
    data.targetMinConf3  = m_settings->value(prefix + "target_min_conf_3", 0.0).toFloat();
    data.targetAimRange  = m_settings->value(prefix + "target_aim_range", 150).toInt();
